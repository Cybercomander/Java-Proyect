...
public class Miembros extends JPanel {
    ...
    public Miembros() {
        ...
        tableModel = new DefaultTableModel(new Object[]{"ID", "Nombre", "Plan", "IMC", "Fecha Nacimiento", "Clase"}, 0) {
    ...
    private void buscarClientes() {
        ...
        for (Cliente c : clientes) {
            if (c.getNombre().toLowerCase().contains(texto)) {
                tableModel.addRow(new Object[]{c.getIdCliente(), c.getNombre(), c.getPlanMembresía(), String.format("%.2f", c.getIMC())});
            }
        }
    }
    ...
    private void mostrarDetalles() {
        ...
        if (c != null) {
            ...
            sb.append("\nPlan: ").append(c.getPlanMembresía());
    ...
    private JPanel crearPanelFormulario(Cliente cliente) {
        ...
        JTextField planField = new JTextField(cliente == null ? "" : cliente.getPlanMembresía());
        ...
        btnGuardar.addActionListener(e -> {
            try {
                ...
                if (cliente == null) {
                    ...
                    if (clase != null) clase.addCliente(nuevo);
                    GestionDatos.getInstancia().guardarDatos();
                    JOptionPane.showMessageDialog(this, "Cliente agregado exitosamente.");
                } else {
                    cliente.setNombre(nombre);
                    cliente.setPlanMembresía(plan);
                    cliente.setFechaNacimiento(fecha);
                    cliente.asignaMedidas(peso, altura, grasa);
                    if (clase != null) cliente.setClase(clase);
                    GestionDatos.getInstancia().guardarDatos();
    ...
    private void editarCliente() {
        ...
        JTextField planField = new JTextField(c.getPlanMembresía());
            ...
            for (entidades.Clase clase : GestionDatos.getInstancia().getClases()) {
                ...
                for (Cliente cli : clientes) {
                    if (cli.getIdCliente() == id) {
                        ...
                        cli.setPlanMembresía(planField.getText());
