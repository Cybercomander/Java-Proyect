...
public class Entrenadores extends JPanel {
    ...
    // "table": TABLA QUE MUESTRA LOS ENTRENADORES EN UNA INTERFAZ GRÁFICA.
    private JTable table;
    // "tableModel": MODELO DE DATOS PARA LA TABLA, PERMITE MANIPULAR LOS DATOS MOSTRADOS.
    private DefaultTableModel tableModel;
    // "btnEditar", "btnEliminar": BOTONES PARA EDITAR Y ELIMINAR ENTRENADORES.
    private JButton btnEditar, btnEliminar;
    // "searchField": CAMPO DE TEXTO PARA BUSCAR ENTRENADORES POR NOMBRE.
    private JTextField searchField;
    // "detallesArea": ÁREA DE TEXTO QUE MUESTRA LOS DETALLES DEL ENTRENADOR SELECCIONADO.
    private JTextArea detallesArea;
    // "panelFormulario": PANEL QUE CONTIENE EL FORMULARIO PARA AGREGAR O EDITAR ENTRENADORES.
    private JPanel panelFormulario;
    // "panelCentral": PANEL PRINCIPAL QUE CONTIENE LA TABLA Y EL FORMULARIO.
    private JPanel panelCentral;
    // "editando": BANDERA QUE INDICA SI SE ESTÁ EDITANDO UN ENTRENADOR.
    private boolean editando = false;
    // "entrenadorEditando": REFERENCIA AL ENTRENADOR QUE SE ESTÁ EDITANDO.
    private Entrenador entrenadorEditando = null;
    ...
    public Entrenadores() {
        ...
        rightPanel.add(new JLabel("Detalles del Entrenador", SwingConstants.CENTER), BorderLayout.NORTH);
    ...
    private void buscarEntrenadores() {
        ...
        for (Entrenador e : entrenadores) {
            if (e.getNombre().toLowerCase().contains(texto)) {
                ...
                tableModel.addRow(new Object[]{e.getNumEmpleado(), e.getNombre(), String.format("%.2f", e.getsalarioDiario()), e.gethoras(), clase});
            }
        }
    }
    ...
    private void editarEntrenador() {
        // Este método ya no se usa, reemplazado por el panel de formulario
    }
